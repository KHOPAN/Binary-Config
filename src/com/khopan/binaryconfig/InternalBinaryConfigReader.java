...
import com.khopan.binaryconfig.BinaryConfigObject.ObjectData;
...
public class InternalBinaryConfigReader {
	...
	private Result recursiveByteDataReader(List<Byte> data) {
		...
		if(isNull) {
			...
			throw new IllegalStateException("Unexpected state, type is not null, primitive, String or BinaryConfigElement");
		}
